...
<div class="container">
    <div class="sign-up">
        ...
        <form action="/public/register.php" method="post">
            ...
            <div style="text-align: center;"><button formaction="/public/register.php" name="submit">Зарегистрироваться</button></div>
        </form>
    </div>
    <div class="sing-in">
        <h2>Авторизация</h2>
        <form action="/public/login.php" method="post">
            ...
            <div style="text-align: center;"><button formaction="/public/login.php" name="submit">Авторизоваться</button></div>
        </form>
    </div>
</div>
</body>
